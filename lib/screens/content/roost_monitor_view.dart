...
class RoostMonitorView extends StatefulWidget {
  final String endpoint;
  const RoostMonitorView({super.key, required this.endpoint});

  @override
  State<RoostMonitorView> createState() => _RoostMonitorViewState();
}

class _RoostMonitorViewState extends State<RoostMonitorView> {
  static const _lastUrlKey = 'roost.last_seen_url';
