...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.affise.attribution.affise_attribution_lib.AffiseAttributionLibPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin affise_attribution_lib, com.affise.attribution.affise_attribution_lib.AffiseAttributionLibPlugin", e);
    }
    try {
